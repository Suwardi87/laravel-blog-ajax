...
@push('meta')
    ...
    <meta name="keyword" content="Tag MyBlog, Blog Technology">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <ol class="breadcrumb justify-content-start mb-4">
                ...
                <li class="breadcrumb-item active text-dark">All Tag</li>
            </ol>
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="mb-4">
                        <a href="#" class="h1 display-5">All Tag</a>
                    </div>
                                        ...
                                        <a href="{{ route('frontend.tag.show', $tag->slug) }}">
                                            <div class="card bg-light mb-3">
                                                <div class="card-body text-center p-4">
                                                    <h5 class="card-title mb-0">{{ $tag->name }} ({{ $tag->total_articles }})</h5>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
